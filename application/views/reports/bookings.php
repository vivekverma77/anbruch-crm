...
<section id="main-content">
	<section class="wrapper" style="width: auto; min-width: 100%;">
		...
		<div class="row">
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<div>
							...
							<form name="frmDates" id="frmDates" method="get" action="<?php echo base_url();?>reports/bookings/1">
						...
						<a class="module_head" href="<?php echo base_url() ?>reports/bookings_print/?own=<?php echo $own; ?>&order_by=<?php echo $order_by; ?>&order=<?php echo $order; ?>&fromDate=<?php echo $fromDate; ?>&toDate=<?php echo $toDate; ?>" target="_blank" style="float: right;">Print</a>
						
						<a class="module_head" href="<?php echo base_url() ?>reports/bookings_export/?own=<?php echo $own; ?>&order_by=<?php echo $order_by; ?>&order=<?php echo $order; ?>&fromDate=<?php echo $fromDate; ?>&toDate=<?php echo $toDate; ?>" style="float: right;margin-right: 2px;">Export</a>					
						<?php } ?>
					
					</header>
                      
                      <div class="uper-total">
					   <div style='margin:50px 20px 10px 0; text-align:right;'>
			...
			<div style="color:#73879C; font-size:14px; margin-top:-15px; position:relative; top:-30px; margin-left:120px; float:left;">
        ...
        <div style="overflow:auto; padding-bottom:20px; width:100%;">
            <table class="display table new-table table-striped table-condensed" id="dynamic-table">
							<thead>
								<tr>

										<th nowrap="nowrap">Sr No.</th>
										<th nowrap="nowrap" class="sort" data-id="ac.booking_title">Booking Title <i class="fa fa-sort"></i></th>
										<th nowrap="nowrap">Booking Date</th>
										<th nowrap="nowrap">Booking Time</th>
										<th class="sort" data-id="ac.name" nowrap="nowrap">Name<i class="fa fa-sort"></i></th>
										<th class="sort" data-id="ac.email" nowrap="nowrap">Email<i class="fa fa-sort"></i></th>                    
										<th nowrap="nowrap">Status</th>                    
										<th class="sort" data-id="ac.created_by" nowrap="nowrap">Created By<i class="fa fa-sort"></i></th>
										<th class="sort" data-id="ac.created_time" nowrap="nowrap">Created Time<i class="fa fa-sort"></i></th>							
								</tr>
							</thead>
							<tbody>
