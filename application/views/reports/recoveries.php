...
table.display thead th {padding:7px 18px 7px 10px; width:auto !important;}
...
<section id="main-content">
	<section class="wrapper" style="width: auto; min-width: 100%;">
		...
		<div class="row">
			<div class="col-sm-12">
				<h3 class="tab-title" style="margin-bottom:10px; font-size:24px;"> <span class="page-title">Recoveries </span></h3>
				<section class="panel">
					<header class="panel-heading">
						...
						<a class="module_head" href="<?php echo base_url() ?>reports/recoveries_print/?own=<?php echo $own; ?>&fromDate=<?php echo $fromDate; ?>&toDate=<?php echo $toDate; ?>" target="_blank" style="float: right;">Print</a>
						
						<a class="module_head" href="<?php echo base_url() ?>reports/recoveries_export/?own=<?php echo $own; ?>&fromDate=<?php echo $fromDate; ?>&toDate=<?php echo $toDate; ?>" style="float: right;margin-right: 2px;">Export</a>					
						<?php } ?>
        		...
        		<div style="overflow:auto; width:100%;">
            		<table class="display table new-table table-striped table-condensed" id="dynamic-table">
							<thead>
								<tr>
									<th nowrap="nowrap" style="min-width:60px; padding:">Sr No.</th>
								...
								?>
									...
									<tr>                   
										...
										<?php } else if($field['id']=='179'){?>
											<td class="tech"><?php if(isset($record_mv[$key]["value"]) && $record_mv[$key]["value"]!="") { echo date("d M, Y", strtotime($record_mv[$key]["value"])); } ?></td>	
										<?php } else { ?>
											<td nowrap="nowrap"><?php echo @$record_mv[$key]["value"]; ?></td>	
										<?php }  }?>
										<td nowrap="nowrap"><?php echo $contract["ofirst_name"]." ".$contract["olast_name"]; ?></td>	
										<td nowrap="nowrap"><?php echo $contract["first_name"]." ".$contract["last_name"]; ?></td>	
