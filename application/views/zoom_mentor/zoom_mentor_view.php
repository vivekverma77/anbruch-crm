...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/zoommentor_view.css">
  <style type="text/css">
	...
	.flip-card-back {background-color: #f24210d1;color: white;transform: rotateY(180deg);height:290px;padding-top: 80px;border-radius:6px;}
	.play_video { position: relative;left:0; top:-30px;font-size:50px;opacity: 0.8;z-index:999; }.flip-card-back a { color: white;border: 1px solid #fff;padding: 10px 20px;text-decoration: none;background: #ce3b12; }
...
<div class="container" id="welcome">
     <div class="row">
	     <div class="col-lg-6 col-md-12 welcome-text" style="border-right:1px solid;text-align:center;">
		     <div>
		     	 <a href="#" style="color: gray;
    font-size: 28px;
    position: relative;
    top: -20px;"><i class="fa fa-film"></i></a>
			     <h5>What It Is All About</h5>
				 <p>
	     ...
	     <div class="col-lg-6 col-md-12 welcome-video" style="text-align: center;">
		     <div style="margin-top: 25px;">
		     	<h4>What is Lorem Ipsum?</h4>
		     	<p style="margin-top:29px; font-size: 13px;">lorem Ipsum is simply dummy text of the printing and typesetting industry.
                     Lorem Ipsum has been the industry's standard dummy text ever since the
                     1500s</p>
    ...
    font-size: 15px;
    border-radius: 5px;
    margin-top: 40px;">GET STARTED NOW</button>
			 </div>
		 </div>
	 </div>
</div>
...
<div class="container" id="testimony">
     <div class="text-center"><h2>PLAN LESSON</h2></div>
	 <div class="row">
	     <div class="welcome-text" style="background: white;width: 900px;margin:0 auto;height:auto;padding:0 50px;">
		     <div class="row" style="padding:30px 0px;border-bottom: 1px solid lightgray">
				<div class="col-sm-2" style="color:black;font-size:32px;">
					<span style="float:right;">01</span>
				</div>
				<div class="col-sm-10" style="color:#555;padding:5px;">
					<h3 style="font-size:22px;">INTRODUCTION</h3>
					<p>
				     Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                     Lorem Ipsum has been the industry's standard dummy text ever since the
                     1500s, when an unknown printer took a galley of type and scrambled it to
		     ...
		     <div class="row" style="padding:30px 0px;border-bottom: 1px solid lightgray">
				...
				<div class="col-sm-10" style="color:#555;padding: 5px;">
					<h3 style="font-size:22px;">GETTING TO KNOW YOUR CHARACTER</h3>
					<p>
				     Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                     Lorem Ipsum has been the industry's standard dummy text ever since the
                     1500s, when an unknown printer took a galley of type and scrambled it to
		     ...
		     <div class="row" style="padding:30px 0px;border-bottom: 1px solid lightgray">
				...
				<div class="col-sm-10" style="color:#555;padding: 5px;">
					<h3 style="font-size:22px;">DEVELOPING YOUR CHARACTER THROUGH RESEARCH</h3>
					<p>
				     Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                     Lorem Ipsum has been the industry's standard dummy text ever since the
                     1500s, when an unknown printer took a galley of type and scrambled it to
		     ...
		     <div class="row" style="padding:30px 0px;border-bottom: 1px solid lightgray">
				<div class="col-sm-2" style="color:black;font-size:32px;">
					<span style="float:right;">04</span>
				</div>
				<div class="col-sm-10" style="color:#555;padding: 5px;">
					<h3 style="font-size:22px;">DEVELOPING YOUR CHARACTERS PHYSICALITY</h3>
					<p>
				     Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                     Lorem Ipsum has been the industry's standard dummy text ever since the
                     1500s, when an unknown printer took a galley of type and scrambled it to
		     ...
		     <div class="row" style="padding:30px 0px;border-bottom: 1px solid lightgray">
				...
				<div class="col-sm-10" style="color:#555;padding: 5px;">
					<h3 style="font-size:22px;">ACTIVE EMPATHY</h3>
					<p>
				     Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                     Lorem Ipsum has been the industry's standard dummy text ever since the
                     1500s, when an unknown printer took a galley of type and scrambled it to
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".play_video").click(function(){
			$(".banner-centent").css('display', 'none');
