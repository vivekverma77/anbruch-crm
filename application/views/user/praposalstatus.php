...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        Swal.fire(
                        {
                          icon: 'success',
                          html:'<div class="container" id="msg-box"> <div class="logo text-center"> <img src="<?php echo base_url()?>/assets/images/logo-hd3.png" alt="anbrch-logo"> </div><div class="text-center msg-content"> <div class="icon"> <img src="<?php echo base_url()?>/assets/images/verified.png"> </div><div class="text"> <p>Proposal has been sent successfully!<br>A confirmation has been emailed to you along with your pre-qualification results. We look forward to speaking with you soon!</p><div class="regards"> <h4>Best regards,</h4> <h3>Anbruch Team</h3> </div></div></div></div>',
