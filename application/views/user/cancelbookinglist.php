            ...
            <table class="display table table-bordered table-striped table-condensed" id="dynamic-table-bookings">
                ...
                <?php $i=1; foreach ($bookings as $key => $booking) { 
                    ...
                    <tr class="tr_<?php echo $booking["id"]; ?>">                       
                        ...
                        <td class="text-center"><span class="<?php echo $info; ?>"><?php echo $booking_status[$booking["status"]]; ?></span></td>
                        ...
                        <td class="text-center">
													...
													<span style="background:#ec7878;color:#fff" class="<?php echo $info; ?>">                       
														<a href="javascript:;" style="text-decoration:none;background:#ec7878;color:#fff" class="cancel_booking" data-id="<?php echo $booking["id"]; ?>">Cancel</a></span></td>
													<?php } ?>
                        </td>
                    </tr>
