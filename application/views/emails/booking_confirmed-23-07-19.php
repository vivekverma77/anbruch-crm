						...
						<table cellpadding="0" cellspacing="0" width="600px" align="center" style="background:#fff; margin-top:80px;">
							...
							<tr>
								<td style="padding-top:20px; padding-bottom:20px" width="100%" align="center">
									...
									<h2 style="color:#ff9800; font-weight:normal; letter-spacing:1px;" > <span style="display:block; font-size:36px; color:#1fb5ad; letter-spacing:1.5px;">Booking done.</span> Awaiting for confirmation!</h2>
