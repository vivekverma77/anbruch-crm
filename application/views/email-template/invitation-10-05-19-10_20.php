        ...
        <tr>
          <td style="padding:0 25px;">
            <p style="border-bottom:1px solid #ddd; margin:0 auto; width:75%; padding:11px 10px 5px; background:#f8f9fa;">
             ...
             <span><?php echo (isset($mailData['start_date']) && !empty($mailData['start_date'])) ? date('Y-m-d',strtotime($mailData['start_date'])) : '' ?> <?php echo (isset($mailData['start_time']) && !empty($mailData['start_time'])) ? date('h:i a',strtotime($mailData['start_time'])) : '' ?></span>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 25px;">
            <p style="border-bottom:1px solid #ddd; margin:0 auto; width:75%; padding:11px 10px 5px; background:#f8f9fa;">
             ...
             <span><?php echo (isset($mailData['end_date']) && !empty($mailData['end_date'])) ? date('Y-m-d',strtotime($mailData['end_date'])) : '' ?> <?php echo (isset($mailData['end_time']) && !empty($mailData['end_time'])) ? date('h:i a',strtotime($mailData['end_time'])) : '' ?></span>
            </p>
          </td>
        </tr>
