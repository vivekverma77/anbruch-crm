            ...
            <div class="col-lg-6" style="margin-left:100px;">
                ...
                <section class="panel new-layout">
                    <header style="margin:-20px -20px 30px; clear:both; padding-left:17px; border-bottom:1px solid #ccc;">
                        ...
                        <div class="title">
                            <h4 style="font-weight:400; letter-spacing:1px;"> Update</h4>
                        </div>

                        <div class="icons-plot">
                            <button type="submit" class="icon create-team">
                                <i class="fas fa-users"></i>
                                <span class="hover-title" style="width:80px; margin-left:-15px;">Update</span>
                            </button>
                        </div>
                    </header>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <input name="name" type="text" required="required" class="form-control" id="name" placeholder="Enter name" value="<?php echo $team['name']; ?>">
                            </div>
										...
										<ul>
											...
											<li>
                                                <a href="Javascript:;" class="small" data-value="<?php echo $user['id']; ?>" tabIndex="-1">
                                                    <label>
                                                        <input type="checkbox" name="members[]" value="<?php echo $user['id']; ?>" <?php if(is_array(json_decode($team["members"])) && in_array($user['id'],json_decode($team["members"]))){ echo 'checked'; } ?>   />
                        ...
                        <div style="text-align:right; margin-top:35px; padding-top:15px; border-top:1px solid #ddd;">
                            <button type="submit" class="btn btn-success">Update <i class="fa fa-users icon-right"></i> </button>
                        </div>
