    ...
    <section class="wrapper">
                            ...
                            <ul class="conversation-list">
                                <li class="clearfix">
                                    <div class="chat-avatar">
                                        <img src="<?php echo base_url() ?>static/images/chat-user-thumb.png" alt="male">
                                        <i>10:00</i>
                                    </div>
                                ...
                                <li class="clearfix odd">
                                    <div class="chat-avatar">
                                        <img src="<?php echo base_url() ?>static/images/chat-user-thumb-f.png" alt="female">
                                        <i>10:00</i>
                                    </div>
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
        ...
        <div class="row">
            <div class="col-md-8">
                <section class="panel">
                    <div class="wdgt-row">
                        <img src="<?php echo base_url() ?>static/images/weather_image.jpg" height="243" alt="">
                        <div class="wdt-head">
                            weather forecast
                        </div>
                    ...
                    <li>
                        <div class="prog-row">
                            <div class="user-thumb">
                                <a href="#"><img src="<?php echo base_url() ?>static/images/avatar1_small.jpg" alt=""></a>
                            </div>
                        ...
                        <div class="prog-row">
                            <div class="user-thumb">
                                <a href="#"><img src="<?php echo base_url() ?>static/images/avatar1.jpg" alt=""></a>
                            </div>
                            <div class="user-details">
                        ...
                        <div class="prog-row">
                            <div class="user-thumb">
                                <a href="#"><img src="<?php echo base_url() ?>static/images/chat-avatar2.jpg" alt=""></a>
                            </div>
                            <div class="user-details">
