    ...
    <section class="wrapper">
        ...
        <div class="col-xs-12">
			...
			<div id="dynamic_content" style="margin-top: 10px;background: #fff;">
				<div class="table-title"> <h3>CLOSINGS</h3></div>
				<div>
        ...
        <div class="col-xs-12">
            ...
            <tr>                       
                <td><a class="list_link" href="<?php echo base_url(). 'index.php/modules/viewRecord/?cm=Leads&id='.$bkng["record_id"].'&record_status='.$bkng['record_status']; ?>"><?php echo $bkng["value"]; ?></a></td>
                <td><?php echo $bkng["booking_title"]; ?></td>
                <td><?php echo date("m/d/Y", strtotime($bkng["booking_date"]));?></td>
                <td><?php echo date("h:ia", strtotime($bkng["booking_date"])); ?></td>
                <td><?php echo $bkng["name"]; ?></td>
                <td><?php echo $bkng["email"]; ?></td>
                <td class="text-center info_status_<?php echo $bkng["id"]; ?>"><span class="<?php echo $info; ?>"><?php echo $booking_status[$bkng["status"]]; ?></span></td>
                <td><?php echo $bkng["first_name"].' '.$bkng["last_name"]; ?></td>
                <td ><?php echo date("m/d/Y", strtotime($bkng["booking_created_time"])); ?></td>
	         ...
	         <?php $i++; 
					...
					{ ?>
						...
						<!-- <div style="padding:25px; text-align:center; border-top:1px solid #e3ebf3;">No Records Found!</div> -->
	  ...
	  <div class="row">
        ...
        <div class="col-xs-12">
			...
			<div id="dynamic_content" style="margin-top:50px;background: #fff;">
				<div class="table-title"> <h3>HOT Leads (CLOSER)</h3></div>						
				<div>
				<form id="record_list_table">
        ...
        <div class="col-xs-12">
			<div id="dynamic_content" style="margin-top:50px;background: #fff;">
				<div class="content-title">BAR GRAPH - STATS - MONTHLY CLOSINGS vs TARGETS</div>						
