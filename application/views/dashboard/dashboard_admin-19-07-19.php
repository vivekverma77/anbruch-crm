	    ...
	    <div class="col-xs-8 main-cols col-right">
        	<div class="calendar-header"> <h3>RECENT BOOKINGS</h3></div>
                  <div id="rec-bookings" class="collapse in"  style="background:#fff;    height: 425px;">
                        ...
                        <div style="background:#fff;padding-bottom: 36px;margin-top: 20px;">
    		...
    		<table id="hot-leads">
    			<thead>
    				<tr>
                        ...
                        <th nowrap>Phone</th>
                        <th nowrap>Email</th>
                        <th nowrap style="padding-left:37px !important;">Action</th>  
                    ...
                    ?>
                        <tr id="<?php echo 'record_id_'.$key; ?>">
                           <td></td>
                            ...
                            <?php if(is_array($record_data_meta['Service Type'])){
                                    $column_name = '';
                                    foreach ($record_data_meta['Service Type'] as $key => $columnName){
                                       $column_name .=   ($column_name == '')? "&lt;$columnName&gt;" : ", &lt;$columnName&gt;";
                                    }?>     
                            <td nowrap><?php echo $column_name; ?></td>
                            <?php }else{?>
                                <td nowrap><?php echo !empty($record_data_meta['Service Type']) ? $record_data_meta['Service Type'] : '-';?></td> 
                            <?php }?>
