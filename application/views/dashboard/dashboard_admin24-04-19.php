...
.data-cols .col {padding:7px 5px; box-shadow:0 10px 40px 0 rgba(62,57,107,.07), 0 2px 9px 0 rgba(62,57,107,.06); width: 355px; height: 147px;}
...
.calendar-row .main-cols.col-right {padding-left:30px; height:418px; }
...
<section id="main-content">
	...
	<div class="clearfix calendar-row" style="margin:30px -15px 0 0;">
			...
			<div class="row">
				<div class="card card--inverse widget-past-days">
                    ...
                    <div style="margin:-30px -1px 0;">
                    	<img src="<?php echo base_url() ?>/assets/images/wave.jpg" style="width:100%">
                    </div>
	    ...
	    <div class="col-xs-8 main-cols col-right">
        	<div class="calendar-header"> <h3>RECENT BOOKINGS</h3></div>
                  <div id="rec-bookings" class="collapse in"  style="background:#fff; height:100%;">
                            <div class="table">
                        ...
                        <div style="background:#fff; height:112%;margin-top: 20PX;">
    ...
    <div class="clearfix calendar-row" style="margin:50px 0 0; display:flex;">
     ...
     <div class="clearfix calendar-row" style="margin:50px -15px 0;display: none;">
         <div class="c-chart-header text-center"><h3>Comparison Chart</h3></div>
         <div class="col-xs-6 main-cols">
            <div  style="background:#fff; height:100%;">
                <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select first user
                  ...
                  <ul class="dropdown-menu">
                    ...
                    ?>  
                      <li><a href="<?php echo base_url().'dashboard?action=charComparison&user_id='.$user["user_id"].'&user_role_id='.$user["role_id"];?>"><?php echo isset($user['first_name']) ? $user['first_name'] :'';?><?php echo isset($user['last_name']) ? ' '.$user['last_name'] :'';?></a>
                      </li>
                    <?php   
                     }
                    }?>
        ...
        <div class="col-xs-6 main-cols">
            <div  style="background:#fff; height:100%;">
                 <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select second user 
                  <span class="caret"></span></button>
                  <ul class="dropdown-menu">
                    <?php if(!empty($users))
                    {
                        foreach ($users as $key => $user) {
                    ?>  
                      <li><a href=""><?php echo isset($user['first_name']) ? $user['first_name'] :'';?><?php echo isset($user['last_name']) ? ' '.$user['last_name'] :'';?></a></li>
                    <?php   
                     }
                    }?>
                  </ul>
               ...
               <?php
                    ...
                    ?>
                        ...
                        <tr id="<?php echo 'record_id_'.$key; ?>">
                            ...
                            <td><?php echo !empty($record_data_meta['Title']) ? $record_data_meta['Title'] : '-';?></td>
                            <td nowrap><?php echo !empty($record_data_meta['Phone']) ? $record_data_meta['Phone'] : '-';?></td>
                            <td nowrap> <a href="mailto:<?php echo !empty($record_data_meta['Email']) ? $record_data_meta['Email'] : '';?>"><?php echo !empty($record_data_meta['Email']) ? $record_data_meta['Email'] : '-';?></a> </td>
...
var myChart3 = new Chart(ctx3, {
 ...
 // Comparision Chart
var chartUser1 = document.getElementById('chartUser1').getContext('2d');
var user1 = new Chart(chartUser1, {
    type: 'bar',
    data: {
        labels: <?php echo isset($user1_chart_label) ? $user1_chart_label :0?>,
        datasets: [{
            label: 'Target: <?php echo isset($selected_user_data) && isset($selected_user_data['monthly_target']) ? $selected_user_data['monthly_target'] :0 ?>',
            data: <?php echo isset($user1_chart_data) ? $user1_chart_data : 0;?>,
             backgroundColor: [
               // 'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
/*var chartUser2 = document.getElementById('chartUser2').getContext('2d');
var user2 = new Chart(chartUser2, {
    type: 'bar',
    data: {
        labels: <?php echo isset($user1_chart_label) ? $user1_chart_label :0?>,
        datasets: [{
