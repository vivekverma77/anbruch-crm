...
<html lang="en">
    ...
    <link rel="shortcut icon" href="https://crm.anbruch.com/static/images/favicon.ico">
    <title><?php echo $title; ?></title>
    
    <link rel="stylesheet" href="https://crm.anbruch.com/static/minified_master/mVersion12.css"/>
    <script type="text/javascript" src="https://crm.anbruch.com/static/minified_master/mVersion12.js"></script>       

    <link href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" rel="stylesheet"/>
    	
    <!-- Custom styles for this template -->
		<link href="https://crm.anbruch.com/static/css/my.css" rel="stylesheet">

    <script src="https://crm.anbruch.com/static/js/jquery.nicescroll.js"></script>
