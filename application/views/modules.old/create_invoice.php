...
.btn{font-size:14px;border:0;padding:6px 12px;background:#57c8f1;    color: #fff;
				...
				<section class="panel detail-panel">
					...
					<div class="panel-body">
						...
						<form role="form" method="post">
							...
							<button type="submit" class="module_head btn">Create Invoice</button>

							<a type="submit" href="javascript:history.back()" class="module_head btn">Cancel</a>
