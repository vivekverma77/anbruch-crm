			...
			<div class="col-lg-12">
				<section class="panel detail-panel">
					<header class="panel-heading">
						Invoice | Created Date: <?php echo date("j-F-Y",strtotime($invoice_data["created_time"])); ?>
										...
										<div class="col-12">
											<div class="card" style="position: relative;display: -ms-flexbox;display: flex;-ms-flex-direction: column;	flex-direction: column;	min-width: 0;word-wrap: break-word;background-color: #fff;background-clip:border-box;border: none;border-radius: .25rem; ">
												...
												<div class="card-body p-0">
													...
													<div class="invoice-right " style="width:50%;float: right;border: 1px solid;width: 30%;font-size: 20px;line-height: 17px;text-align: center;">
