...
margin-left: 20px !important;
 ...
 .fc-year-view .fc-event-container{
 /*display: none !important;*/
}
.fc-year-view .fc-year-month-border{
  display: none !important;
}
.fc-year-view .fc-year-month-separator{
  /*display: none;*/
  width: 1% !important;
}
...
#addClassSchedule1 .modal-dialog{
  width: 40%;

}
#addClassSchedule1 .location-icon1 {
    float: right;
    margin-top: 2px;
    margin-right: 0px;
    color: #fff;
...
#addClassSchedule1 .calendar{
  border: 0px !important;
  margin-top: 5px !important;
  margin-left: 20px !important;
  background-color: white !important;
}
#addClassSchedule1 .guest1{
  border: 0px !important;
  width: 397px !important;
...
#addClassSchedule1 .scroller1{
  margin-top: 5px !important;
}
#addClassSchedule1 .modal-footer{
  border-top: 0px !important;
}
#addClassSchedule1 .modal-footer{
  padding-top: 0px !important;
}
#addClassSchedule1 .save-btn{
    width: 93px;
    height: 35px;
    font-size: 135%;
    margin-right: 0px !important;
...
#addClassSchedule .close, #editClassScheduleNew .close{
  position: absolute;
  margin-top: -28px;
  margin-left: 200px;
}
...
#addClassSchedule .add-notification{
  margin-top: 0px;
  margin-bottom: 15px;
  margin-left: 12px;
}

#editClassScheduleNew .add-notification{
  margin-top: -25px;
  margin-bottom: 15px;
  margin-left: 39px;
}
...
#eventViewModal .service-box span {
   font-size: 14px;
   margin-bottom: 8px;
   display: inline-block;
}
...
#eventViewModal .service-box label, .service-box .label-col{
    font-weight: 400;
    font-size: 14px;
}
.calendar-div{
...
#editClassScheduleNew .notes-div .controls{
  width: 106%;
}
 
#addClassSchedule .notes-div .controls{
  width: 109%;
}
.close-div{position: relative;z-index: 130;
    /* left: -338px; */
    top: 4px;
    cursor: pointer;
    /* display: inline-block; */
...
#addClassSchedule .file_uploader, #editClassScheduleNew .file_uploader {
    border: 2px dashed #1eb5ad;
    background: #f1f3f4;
    padding: 6px;
    position: relative;
    text-align: center;
...
#addClassSchedule .file_uploader input, #editClassScheduleNew .file_uploader input {
    position: absolute;
    width: 100%;
    height: 100%;
    left: 0;
...
#editClassScheduleNew .guest-list-scroller {max-height:110px; overflow:auto;}
...
#editClassScheduleNew .attached_files .fa-paperclip{
   font-size: 24px;
    margin-left: 1px;
    margin-right: 10px;
}
...
#eventViewModal .invited_dv{
  max-height: 145px;
  overflow: auto;
}
#fullCalModal .modal-header .icons-plot {width:50%;}

#fullCalModal .title {width:45%;}
...
#editClassSchedule .location-div1 {
    padding-right: 19px !important;
    width: 85% !important;
}
#editClassSchedule #book_status strong{
...
#editClassSchedule .repeat input {cursor: pointer;
    color: #c2c2c2 !important;
    border-radius: 4px !important;
    border: 1px solid #d2dae1;
    /* margin-right: 10px; */
...
#editClassScheduleNew .modal-body .event-recurrence {
  display: block !important;
}
#editClassSchedule .modal-body .event-recurrence {
  display: block !important;
}
#editClassSchedule .invite{
...
.fc-event-container .fc-day-grid-event:not(.fc-not-end):after{content: '\f274';
...
#collapse:hover{    color: #fff !important;
    opacity: .9;}
#expand:hover{    color: #fff !important;
    opacity: .9;}
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <aside class="col-lg-12">
                        ...
                        <img src="<?php echo base_url('assets/images/calendar-load.gif');?>" class="calendar-loader hide" style="position: absolute;top: 45%;right: 45%;z-index: 1;width: 125px">
                    </aside>                   
...
<!--
        <a href="javascript:void(0)" class="edit_schedule" alt="Booking Class" title="Edit Booking" style="font-size: 19px;margin-right: 10px;"><i class="far fa-edit"></i>Edit</a>

        <a href="javascript:void(0)" class="delete_schedule" alt="Booking Cancel" title="Cancel Booking " style="font-size: 19px;margin-right: 10px;" ><i class="far fa-trash-alt"></i>Delete</a>
        
        <a href="javascript:void(0)" data-dismiss="modal" class="" title="Close modal" style="font-size: 19px;margin-right: 10px;" ><i class="fa fa-times"></i>Close</a>    
-->
<!--
        <button type="button" class="btn btn-danger delete_schedule" ><i class="far fa-trash-alt"></i>Delete</button>
-->
  ...
  <div class="modal-dialog">
    ...
    <form id="frmEditBooking3" name="frmEditBooking3" method="post" action="<?php //echo base_url('booking/bookupdate');?>">  
      ...
      <div class="modal-header background-green">
       ...
       <div class="title"> <h4 id="classScheduleTitle" class="modal-title"></h4> </div>
       <div class="icons-plot">

          <button class="icon update_schedule_timing2">
            <i class="far fa-save"></i>
            <span class="hover-title" style="margin-left:-8px;">Update</span>
          </button>
      ...
      <div id="classScheduleBody" class="modal-body">
        ...
        <div class="row flex-row">
          ...
          <div class="col-sm-8 col-xs-12">
            ...
            <div class="row event-day-time">
              <div class="col-xs-12">
                <input class="input-xlarge form-control datepicker" name="start_date" id="start_date"  type="text" required="" value="" required autocomplete="off">
                ...
                <input class="input-xlarge form-control datepicker" name="end_date" id="end_date4" type="text" placeholder="MM/DD/YYYY" value="" autocomplete="off">
              ...
              <div class="col-xs-12">
                  ...
                  <span class="booking_availability fade" style="visibility: hidden;">
                    <a href="javascript:" class="check_booking">Check Availability</a>
                  </span>
                  <span class="booking_availability_show fade" style="padding:2px 7px;">
             ...
             <div class="row event-day-time get-notify" style="margin-top:20px; display:none;">
              <div class="col-sm-3 col-xs-6" style="padding-right:0">
                  <label class="control-label" for="textfield">Add Remindar</label>
              ...
              <div class="col-sm-3 col-xs-6 all_dv repeat">
                ...
                <input type="number" id="notification_interval1" name="notification_interval" placeholder="before" class="before-time" max="12" min="1" value =  >
              </div>
            ...
            <div class="row event-day-time get-notify1" style="margin-top:20px; display:none">

            </div>
            
            <button type="button" class="btn btn-success add-notification" id="add-notification-btn" style="display:none;">Add Remindar</button>
          ...
          <div class="col-sm-4 col-xs-12" style="border-left: 1px solid #ccc;"> 
            ...
            <div class="form-group">
              <div style="margin-bottom:5px;"> <strong>Name :</strong> <span id="name_status" style="display:inline-block;"></span> 
                <input type="hidden" name="lead_name" id="lead_name" value="">
              </div>
              <div style="margin-bottom:5px;"> <strong>Email :</strong> <span id="email_status" style="display:inline-block;"></span> </div>
              <div id="book_status" style="margin-top:5px; border-top:1px solid #ddd; padding-top:5px;"> <strong>Status :</strong> <span name="status" id="status" class="client_booking_status" style="/*background:#1fb5ad;*/"></span> </div>
              <div id="suggestion" style="display:none; margin-top:5px; border-top:1px solid #ddd; padding-top:5px;"> <strong>Suggested Time by Client:</strong> <br> <span name="status" id="suggestionTime"></span> </div>
        ...
        <div class="row">
            ...
            <div class="tab-title" style="margin-top:40px;"> <span>Notes & attachment</span> </div>
            <div class="form-group">
              <div class="controls">
        ...
        <div class="row">
            <div class="col-xs-12">
              ...
              <div class="attached_files" style="margin: 0 0px 20px;">  
                <i class="fa fa-download"></i> <a href="#" id="attachment" name="attachment" class="btn-link" download title="Download file"></a>
              </div>
              ...
              <div class="file_uploader">
                ...
                <span class="choose">Choose a file</span> or Drag and drop </span>
              </div>
          </div>          
        </div>  
      ...
      <div class="modal-footer">      
        ...
        <button type="button" class="btn btn-success update_schedule_timing2">Update</button>
          ...
          <span class="icon close-modal close-div" data-dismiss="modal">
            ...
            <div class="row event-day-time">
              <div class="col-xs-12">
                ...
                <input class="input-xlarge form-control start_time_dv" name="start_time" id="start_time" value="" required="" type="text" autocomplete="off">
                <span style="margin-right:8px;"> to </span>
                <input class="input-xlarge form-control datepicker" name="end_date" id="end_date4" type="text" placeholder="MM/DD/YYYY" value="" autocomplete="off" style="display:none">
                <input class="input-xlarge form-control timepicker start_time_dv" name="end_time" id="end_time" value="" type="text" placeholder="HH:MM" autocomplete="off">
                ...
                <!--  
                  <span class="booking_availability fade" style="visibility: hidden;margin-left:0px;">
                    <a href="javascript:" class="check_booking">Check Availability</a>
                  </span> -->
  ...
  <div class="modal-dialog modal-md">
    ...
    <form id="frmAddBooking1" name="frmAddBooking1" method="post" action="<?php echo base_url('calendar/add');?>">  
      ...
      <div id="classScheduleBody" class="modal-body">
        ...
        <!-- <div class="col-xs-4 repeat"> 
        <label>Repeat: </label> 
                    <select name="repeat" id="calendar_type"> 
        ...
        <!--  <button type="button" class="btn btn-success add-notification" id="add-notification-btn" data-event='1' disabled>Add Remindar</button>       -->
            <div class="scroller1">
              <div class="row">
...
<div id="addClassSchedule" class="modal fade" data-backdrop="static" data-keyboard="false"> 
  <div class="modal-dialog modal-lg">
    ...
    <form id="frmAddBooking" name="frmAddBooking" method="post" action="<?php echo base_url('calendar/add');?>">  
        ...
        <div class="row">
          ...
          <div class="col-xs-8" style="margin-left: -25px;">
            <div class="form-group event-day-time">
                ...
                <!-- <label class="control-label" for="textfield" style="text-transform:uppercase;">Title</label> -->
              <div class="controls">
      ...
      <div class="row event-day-time">
          <div class="col-xs-12">
            <input class="input-xlarge form-control datepicker" name="start_date" id="start_date2"  type="text" placeholder="MM/DD/YYYY" value="" autocomplete="off">
            ...
            <div class="scroller">
              <div class="row">
                ...
                <div class="calendar-div">    
                  ...
                  <div class="col-xs-11 notes-div">
                      <!-- <label class="control-label" for="textfield" style="text-transform:uppercase; margin-top:30px;">Notes</label> -->
...
$(function() {
  ...
  $('#booking_calendar').fullCalendar({
    ...
    dayClick: function(date,jsEvent, view) {
       $('#editClassSchedule #start_time').val(date.format('h:mm a'));
        $('#editClassSchedule #start_date').val(date.format('MM/DD/YYYY'));
         $('#editClassSchedule #end_date4').val(date.format('MM/DD/YYYY')); 
          var endDate = date.add(15,"m");
        $('#editClassSchedule #end_time').val(endDate.format('h:mm a'));
  ...
  //  var theTimearrr = parseInt(theTime1);
   if (theTime[0]=='12' && theTime1[1]=='am') { 
   ...
   else
    {
      ...
      $("#editClassSchedule #end_time").val(theTime2+":"+theTime3+" "+theTime1[1]);
  });
  /* new code end here */ 
  ...
  var Script = function ()
  {
    ...
    $('#calendar').fullCalendar({
                ...
                if(data.booking)
                {
                  ...
                  else
                  {
                    ...
                    $.ajax({
                      ...
                      data:{ booking_id:booking_id, record_id:record_id, start_date:start_date, start_time:start_time, end_date:end_date, end_time:end_time,email:email, dragEvent:true },
                      dataType:'json',
                      success:function(data)
                      {
                        if(data.success == false)
      ...
      { 
        ...
        element.click(function()
        {
          ...
          if(type=='booking')
          {
            ...
            $('#editClassSchedule #end_date4').val(end_date);
            ...
            // var modify_event = event.modify_event; 
            // if(modify_event==1)
            // {          
            //  $('input[name="modify_event"]').prop('checked', true);
            // }
            // else
            // {
            //  $('input[name="modify_event"]').prop('checked', false);
            // }          
            
            // var invite_others = event.invite_others;               
            // if(invite_others==1)
            // {          
            //  $('input[name="invite_others"]').prop('checked', true);
            // }
            // else
            // {
            //  $('input[name="invite_others"]').prop('checked', false);
            // }  
            
            // var see_guest_list = event.see_guest_list;               
            // if(see_guest_list==1)
            // {
            //  $('input[name="see_guest_list"]').prop('checked', true);
            // }
            // else
            // {                
            //  $('input[name="see_guest_list"]').prop('checked', false);
            // }    
      ...
      { 
          //console.log(jsEvent);
          //$("#addClassSchedule1 .modal-dialog").css('top',jsEvent.pageY);
           //$("#addClassSchedule1 .modal-dialog").css('left',jsEvent.screenY);
           //alert(jsEvent.pageX);
          //alert(jsEvent.pageY);
          //var dialog = $("#addClassSchedule1 .modal-dialog");
       ...
       $('#addClassSchedule1 #start_date1').val( date.format('MM/DD/YYYY'));
        $('#addClassSchedule1 #end_date1').val( date.format('MM/DD/YYYY'));
                $('#addClassSchedule1 #start_time1').val( date.format('h:mm a'));
                var endDate = date.add(1,"h");
                $('#addClassSchedule1 #end_time').val( endDate.format('h:mm a'));
       ...
       if(event.class == 'calendar_event'){
        ...
        if(event.notification.length){
              var Notification;
              var html1 = '<div class="col-xs-3"><label class="note1"></label><select name="notification_via" id="" class="notification_via"><option  selected value="1">Email</option></select></div><div class="col-xs-3 notification_interval" style="margin-right:-58px !important"><input type="number" id="notification_interval1" name="notification_interval" min = "1" max = "12" placeholder = "before"/></div><div class="notification_type interval"><select class="notification" id="notification_type" name="notification_type"><option  value="1">hours</option><option value="2">days</option></select></div>';
         ...
         $("#eventViewModal .jobName").text(event.title);
              var estimator_id = event.estimator_id;
                 // $("#eventViewModal #estimator option[value='"+estimator_id+"']").attr("selected","selected");
                  ...
                  {
                    $("#eventViewModal .startDay").text(event.start.format('MM/DD/YYYY'));
                   /*  $("#eventViewModal .allDay").html('<i class="fa fa-check"></i>');*/
                     $("#eventViewModal .allDay").html('Yes');
                      if(event.end){
                       $("#eventViewModal .endDate").text(event.end.format('MM/DD/YYYY'));
                      }else{
                        $("#eventViewModal .endDate").text(event.start.format('MM/DD/YYYY'));
                      }
                  }else
                  {
                    $("#eventViewModal .startDay").text(event.start.format('MM/DD/YYYY h:mm a'));
                  ...
                  if(typeof(event.start)!='undefined' && event.start !=null)
                          {                 
                    $("#editClassScheduleNew #start_time").val(event.start.format('h:mm a'));
                  }
                
                $("#editClassScheduleNew #end_time").val(event.endTime);
             ...
             if(event.allDayEvent ==1)
              ...
              // if(yes>0) $('#editClassScheduleNew .guest_yes').html(yes+' yes,');
              // if(maybe>0)  $('#editClassScheduleNew .guest_maybe').html(maybe+' maybe,');
              // if(no>0)  $('#editClassScheduleNew .guest_no').html(no+' no,');
              // if(awaiting>0)  $('#editClassScheduleNew .guest_awaiting').html(awaiting+' awaiting');
  ...
  //$(document).on('paste','.invite', function(e) {
    //var email = e.event;
    //console.log(email);
    //var _this = e;
    //var email = _this.val();    
  ...
  //$(document).on('change','#start_date, #start_time',function()
  //{
    //var start_date = $('#start_date').val();    
    //var start_time = $('#start_time').val();
...
$("#start_date2").datepicker({ minDate: 0 });
...
$(document).on("click","#editClassSchedule button.update_schedule_timing2",function(){ 
  if(!$("#editClassSchedule #end_date4").val()) { 
    // $("#editClassSchedule #end_date4").val($("#editClassSchedule #start_date").val());
  }
  var status = false;
  ...
  if(form3.valid())
  {
   ...
   if(start_time != '' && end_time != '')
    {
      start_time = $("#editClassSchedule #start_time").val().split(' ');
      end_time = $("#editClassSchedule #end_time").val().split(' ');
      if(start_time[1] == 'am' && end_time[1] == 'am')
      {
        var st = start_time[0].split(':');
        var st_hr = parseInt(st[0]);
        var st_min = parseInt(st[1]);
        var et = end_time[0].split(':');
        var et_hr = parseInt(et[0]);
        var et_min = parseInt(et[1]);
        if(st_hr > et_hr)
        {
          status = false;
        }
        ...
        {
          status = st_min > et_min ? false : true;
        }
      }
      else if(start_time[1] == 'pm' && end_time[1] == 'pm')
      {
        var st = start_time[0].split(':');
        var st_hr = parseInt(st[0]);
        var st_min = parseInt(st[1]);
      ...
      {
        status = start_time[1] == 'am' ? true : false;
      }
    }
   if(status)
   {
      $("#editClassSchedule #time-error").text('');
      $("#editClassSchedule #time-error").css('display','none');
   }
   else
   {
      $("#editClassSchedule #time-error").text('Invalid Booking Schedule time');
  ...
  $.ajax({
    ...
    dataType: 'JSON',
        success: function (data) { 
          ...
          $("#addClassSchedule #start_date2").val(data['calendarJobs'][0]['start_date']);
          $("#addClassSchedule #start_time").val(data['calendarJobs'][0]['start_time']);
          $("#addClassSchedule #end_date").val(data['calendarJobs'][0]['end_date']);
...
<script type="text/javascript">
 ...
 $("#frmEditBooking3 #start_time").timepicker({
  ...
  function availCheck(){
    ...
    $('.booking_availability_show').removeClass('in');
    $('.booking_availability').addClass('in').css("visibility","visible");
   // $("#editClassSchedule .update_schedule_timing2, .add_schedule_timing").attr("disabled","disabled");
    //$("#editClassSchedule .update_schedule_timing2, .add_schedule_timing").prop("disabled", true);
  }
...
var placeSearch, autocomplete;
     ...
     /* $(document).on('change', '#editClassSchedule #start_date3', function(){
       var start_date = $(this).val();
          ...
          var todayDate = mm + '/' + dd + '/' + yy;
           if(new Date(start_date)< new Date(todayDate)){
            alert('if');
            $("#editClassScheduleNew #start_date3").addClass("intro");
           // $('#end_date').val('');
           // $('#end_time').val('');
            //$('#start_time').val('');
          }
            ...
            alert('else');
           $("#editClassScheduleNew #start_date3").removeClass("intro"); 
 ...
 $(document).on('click', '#add-notification-btn', function(){
  var html1;
      if($(this).attr('data-event') == 1){
        html1 = '<div class="col-xs-3"><label class="note1"> </label><select name="notification_via" id="notification_via1" class="notification_via"><option selected value="1">Email</option></select></div><div class="col-xs-3 notification_interval" style="margin-right:-59px !important"><input type="number" class="interval" id="notification_interval1" min=1 max=12 name="notification_interval" placeholder = "before"/></div><div class="notification_type"><select id="notification_type" name="notification_type" class="notification"><option value="1">hours</option><option value="2">days</option></select></div><i class="fas fa-times close" id="close-notification" ></i>';
           $('.get-notify2').html(html1);
            $('#notification_interval1').val('1');
      
      }else{
       html1 = ' <div class="col-sm-3 col-xs-6" style="padding-right:0 margin-right:14px"><label class="control-label note1" for="textfield">Remindar</label><select name="notification_via" id="calendar_type" class="notification-via" ><option selected="" value="1">Email</option></select></div><div class="col-sm-3 col-xs-6 all_dv repeat"><label class="control-label" for="textfield"></label><input type="number" class="interval" id="notification_interval1" name="notification_interval" placeholder="before" class="before-time" max="12" min="1" ></div><div class="col-sm-3 col-xs-6 all_dv note"><label class="control-label" for="textfield"></label><select id="notification_type" name="notification_type" class="notification-via notification"><option selected="" value="1">hours</option><option value="2">days</option></select></div><i class="fas fa-times close" id="close-notification"></i>'
...
/*$(document).on('click','#addClassSchedule .add_invite' , function(){
    $('.add-notification').attr('disabled', false);
  })

  $(document).on('click', '.remove_invite', function(){
    if($('#addClassSchedule .invite_dv .invite').length == 0){
      $('#addClassSchedule .add-notification').attr('disabled', true);
      }  
  })*/

  /*$(document).on('click','#editClassScheduleNew .add_invite' , function(){
    $('.add-notification').attr('disabled', false);
  })
*/
  /*$(document).on('click', '.remove_invite', function(){
    if($('#editClassScheduleNew .invite_dv .invite').length == 0){
      $('#editClassScheduleNew .add-notification').attr('disabled', true);
      }  
  })*/
 $(document).on('click', '#fullCalModal #delete-booking', function(){
  ...
  $('#addClassSchedule1 .guest1').keypress(function(e){
    ...
    $('#addClassSchedule .invite_dv').append(html1);
       ...
       /* if($('#addClassSchedule .guest_dv .guest2').length == 0){
         $('#addClassSchedule1 .guest2').val(email);
        }else{
            $('#addClassSchedule1 .guest_dv:first-child').val(email);
          }*/
    }
  });
  ...
  $(document).on('click', '.saveEvent', function(){
      ...
      $('#addClassSchedule #start_date2').val($('#addClassSchedule1 #start_date1').val());
...
/*$(document).on('click', '#calendar .fc-month-button', function(){ 
  addClass();
});
$(document).on('click', '#calendar .fc-year-button', function(){ 
  addClass();
});
