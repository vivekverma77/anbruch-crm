...
<style type="text/css">
    ...
    #modalConvert .modal-header { background: #1fb5ad; color: white; }
    #modalConvert .close { color: white; opacity: 1; }
    #modalConvert .modal-title { font-weight:700; }
    .required + .select2{
        border-radius: 5px !important;
        border: 1px solid blue ;
    }
    #back-btn:focus{background-color: #fa8564;}
    #back-btn:hover{color: #1ca59e !important;}
</style>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                      <div style="position: absolute;">
                        New <?php echo $current_module; ?>
                            ...
                            <div style="top: 38px;">
                                <a href="#" class="btn btn-danger pull-right" id="back-btn"><i class="fas fa-window-close" style="padding-right: 5px;"></i>Cancel</a>
                            </div>
                    </header>
                    ...
                    <div class="panel-body">
                        ...
                        <?php } 
                        ?>
                        <form role="form" id="addContract" action="?cm=<?php echo $current_module; ?>&ac=new" method="post">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select name="__0" id="0" style="width: 100% !important; padding: 5px;" class="populate" required="required" > 
                                     <?php } else {?>   
                                       <select name="__0" id="0" style="width: 100% !important; padding: 5px;" class="populate" required="required" >
                                       <?php }?> 
                                        <?php //print_r($sessionData); die("cool");
                            ...
                            <?php
								//echo '<pre>';print_r($meta_fields[5]);die;
                                $section_name = "";
...
<div class="form-group col-lg-6" style="min-height: 57px !important;">
    ...
    <select name="__<?php echo $meta['id'] ?>[]" class="multi-select <?php echo ($required) ? "required": ""; ?>" style="width: 100% !important; padding: 5px;" multiple="multiple" id="<?php echo $id ?>" <?php echo ($required) ? 'required="required"' : ""; ?> >
        ...
        $("#add_contract_btn").click(function(){ 
            ...
            for(var i = 0; i < reqlength.length; i++){
                if($(reqlength[i]).val() == ''){
                    ...
                    //$(reqlength[i]).css('box-shadow', '5px 10px #888888 !important'); 
                    //$(reqlength[i]).css('background', 'red'); 
                     $('html, body').animate({
