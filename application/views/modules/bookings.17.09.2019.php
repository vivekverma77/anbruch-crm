...
<div class="card bordered-card color-yellow collapsible-card">
	...
	<?php if (isset($bookings) && count($bookings) > 0) { ?>
		 <div class="table-responsive">
		 	<style type="text/css"> #dynamic-table-bookings {width:1000px !important;} </style>
            <table class="display table new-table table-striped table-condensed" id="dynamic-table-bookings" style="max-width:100% !important;width:1000px !important;">
                ...
                <?php $i=01; foreach ($bookings as $key => $bkng) { 
                    ...
                    <tr id="booking_id_<?php echo $bkng["id"]; ?>">                       
                        ...
                        <td nowrap="nowrap">
                        	<?php echo $bkng["all_day"] == 1 ? date("m/d/Y", strtotime($bkng["booking_date"])) : date("m/d/Y", strtotime($bkng["booking_date"]));?>
                        </td>
                        <td nowrap="nowrap">
                        	<?php 
                        	  if($bkng["all_day"] == 1){
                        	   echo $bkng["end_date"] != null ? date("m/d/Y", strtotime($bkng["end_date"])) : '-';	
                        	  	...
                        	  	$endTime =  $bkng["end_date"] != null && $bkng['booking_date'] != null ? date("h:i a", strtotime($bkng["booking_date"])) .' to '. date("h:i a", strtotime($bkng["end_date"])) : '-';
                        	  	echo $endTime;
                        ...
                        <td class="text-center info_status_<?php echo $bkng["id"]; ?>">
                        	<span class="<?php echo $info; ?>"> <span class="status_txt"><?php echo $booking_status[$bkng["status"]]; ?></span></span> 
                        </td>
                       ...
                       <!--  <td><?php echo $bkng["all_day"] == 1 ? "<i class='fa fa-check'></i>" : 'No' ;?></td> -->
                         ...
                         <td><?php echo $bkng["praposed_date"] > 0 ? date("m/d/Y",strtotime($bkng["praposed_date"])) : '-'; ?></td> 
                         <td><?php echo $bkng["praposed_date"] > 0 ? date("h:i a",strtotime($bkng["praposed_date"])) .' To '. date("h:i a",strtotime($bkng["praposed_end_time"])): '-'; ?></td> 
                         <td nowrap="nowrap"><?php echo date("m/d/Y h:i a", strtotime($bkng["created_time"])); ?></td>
