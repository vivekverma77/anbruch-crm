...
<div id="collapse-qualified" class="collapse in">
	...
	<div class="form-group col-lg-12" >
			...
			<strong>1. Are you selling goods to Canada?</strong>
...
<?php if($qualified['selling_goods_to_canada']=='yes') { ?>
	...
	<div class="form-group col-lg-12" >
			...
			<strong>2. Approximately, what are your annual $$ sales to Canada?</strong>
			<ul class="customer-info">
	...
	<div class="form-group col-lg-12" >
			...
			<strong>3. Do you pay a customs broker to import those goods into Canada?</strong>
			<ul class="customer-info">
				<li>
	...
	<div class="form-group col-lg-12" >
			...
			<strong>4. Are you registered for Canadian Sales Tax?</strong>
	 ...
	 <div class="form-group col-lg-12" >
			...
			<strong>5. How often do you file your Canadian Sales Tax Returns </strong>
	 ...
	 <div class="form-group col-lg-12" >
			...
			<strong>6. Are the accounting records for Canadian Sales stored in the USA?</strong>     
	 ...
	 <div class="form-group col-lg-12" >
			...
			<strong>7. Are the Canadian Sales Tax returns processed and filed from:</strong>     
	...
	<div class="form-group col-lg-12" >
			...
			<strong>8. Have you had a Canadian Tax Consultant conduct a REVERSE AUDIT of your Canadian Sales Tax (GST) in the past 4 years? </strong>     
	...
	<div class="form-group col-lg-12" >
			...
			<strong>9. Have you had the Canadian Government audit your Canadian Sales Tax (GST) in the past 4 years? </strong>     
	...
	<div class="form-group col-lg-12" >
			...
			<strong>10. Do you have operations in Canada? </strong>
